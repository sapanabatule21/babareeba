...
// 🎵 ३ नवीन १००% वर्किंग प्रिमियम MP3 गाण्यांची प्लेलिस्ट
const PLAYLIST = [
  {
...
export default function Home() {
  ...
  // 🎛️ TAP बटन क्लिक हँडलर - प्रत्येक क्लिकवर गाणं आणि नाव बदलणार
  const handleTapInteraction = () => {
    if (!audioRef.current) return;

    // जर म्युझिक चालू नसेल (फर्स्ट टाईम टॅप)
    if (!isPlaying) {
      audioRef.current.src = PLAYLIST[currentTrackIndex].src;
      audioRef.current.load(); // ऑडिओ फाईल फोर्स लोड करा
  ...
  // गाणं संपल्यावर आपोआप पुढचं गाणं सुरू होण्यासाठी
  ...
  // ॲनिमेशनसाठी Intersection Observer Effekt
  useEffect(() => {
  ...
  return (
    <div className="w-full min-h-screen bg-neutral-950 text-neutral-100 overflow-hidden select-none">
      ...
      {/* 🎵 बॅकग्राउंड ऑडिओ प्लेअर एलिमेंट */}
      <audio 
        ref={audioRef} 
      ...
      <section className="relative w-full h-screen flex flex-col justify-center items-center px-4 sm:px-6 md:px-12">
        ...
        {/* 🎥 प्रिमियम बॅकग्राउंड व्हिडिओ लेयर */}
        ...
        {/* 🎵 NOW PLAYING - चालू असलेल्या गाण्याचं नाव इथे दिसेल */}
        ...
        {/* CENTER BRAND PIECE (Logo + Typography) */}
      ...
      <section className="w-full bg-neutral-950 border-y border-neutral-900/60 py-6 sm:py-8 flex overflow-x-hidden relative z-20">
        <div className="flex whitespace-nowrap animate-marquee text-4xl sm:text-6xl md:text-7xl font-serif tracking-widest uppercase text-neutral-900 font-bold opacity-50">
          <span className="mx-12 text-outline">MUSIC MAKES MY HEART GO BA BA REEBA •</span>
          <span className="mx-12">MUSIC MAKES MY HEART GO BA BA REEBA •</span>
        </div>
      </section>
